...
const LeftCom = ({
  ...
  return (
    <div
      className={`w-full lg:w-1/2 flex flex-col justify-center gap-4 h-full text-[16px] px-4 sm:px-6 lg:px-24 py-10 lg:py-0`}
    >
      ...
      <p className="text-sm sm:text-base text-textinsu max-w-xl mb-5">{description}</p>
