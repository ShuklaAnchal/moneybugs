  ...
  return (
    <div className='flex flex-row gap-10 flex-wrap lg:justify-between justify-center px-3'>
      {cardData.map((item, index) => (
        <div key={index} className='w-[316px] h-[426px] bg-black mb-5 rounded-[110px] relative overflow-hidden'>
          <img src={item.cardimg} alt='bg image' className='absolute z-0 h-full w-full inset-0 object-cover' />

          <div className='h-[106px] w-full bg-black absolute bottom-0 left-0 z-10 text-center flex flex-col justify-center'>
