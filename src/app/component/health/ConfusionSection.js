...
const ConfusionSection = ({
  ...
  return (
    <div className="bg-primary mb-10 text-white w-full py-10 px-5 lg:px-20 flex flex-col lg:flex-row items-center justify-between gap-10">
      {/* Left Side */}
      ...
      {/* Right Side */}
      <div className="w-full lg:w-1/2 bg-white text-black p-6 rounded-xl shadow-lg max-w-md">
        {showForm ? (
          <>
            ...
            <form className="flex flex-col gap-4">
              ...
              <button
                type="submit"
                className="bg-[#FF6A00] hover:bg-orange-600 text-white text-sm font-medium px-6 py-2 rounded-full transition mt-2"
              >
                Submit
              </button>
            </form>
